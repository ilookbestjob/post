...
class compareBase
{
    ...
    private $RemoteServer = '212.109.14.195';
    private $RemoteBase = 'nordcom';
    private $RemoteUser = 'vlad';
    private $RemoteBdPassword = 'ckj;ysqnc';
    ...
    public function connectLocal()
    {
        ...
        return mysqli_connect($this->server, $this->user, $this->bdpassword, $this->base, $this->port);
    }
    ...
    public function compareBaseData($table, $equalfields, $fieldstocompare = array(), $filter = array(), $limit = 1000)
    {
        ...
        while ($sqllocal_row = mysqli_fetch_array($sqllocal_result)) {
            ...
            /*
            echo "remote</br></br></br>";
            print_r($sqlremote_row);

            echo "<hR>local</br></br>";
            print_r($sqllocal_row);
            echo "</br></br></br>";
...
*/
    ...
    public function checkBases($posttype_id)
    {
        if ($this->checkConnections()) {
            //$this->compareStructure(array("post", "postwork", "postcalc"));

            //$this->compareBaseData("post", array("posttype_id", "code"), array("city1_id", "store1_id", "city_id", "store_id", "name", "posttype_id", "code", "street", "streettype_id", "house", "x", "y", "flupd", "data", "phone", "mail", "comm", "work", "pref", "flholiday", "flnoact", "flmoney", "flterminal", "period", "flkurier", "typeoffice", "tariff", "limitvolume", "limitload", "post_id", "dataupd"), array("posttype_id" => $posttype_id), 0);
