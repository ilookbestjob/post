...
?><tr><td>Перевозчик</td><td>Вес</td><td>Объем</td><td>Мест</td><td>Дней</td><td>Сумма</td></tr><?
line(1,"DPD",$ves,$vol,$mest,$adr2);
line(2,"ЖелДор",$ves,$vol,$mest,$adr2);
line(3,"ДЛ",$ves,$vol,$mest,$adr2);
//line(4,"ПЭК",$ves,$vol,$mest,$adr2);
?><tr><td colspan=9 style="border-left:0px;border-right:0px;"></td></tr><?
...
//	echo $sql;
	...
	if ($fl==true){
		?><tr><td><?=$nm?></td><td><?=$ves?></td><td><?=$vol?></td><td><?=$mest?></td><td><?=$days?></td><td><?=$sm?></td></tr><?
	}
}
?>